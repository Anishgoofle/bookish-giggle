...
$sel_user = "SELECT * FROM `cruser` WHERE username='$myusername' AND password='$mypassword' AND type='admin'";
...
header("location:iconic/home.php");
...
<html>
		...
		<div class="container">
				...
				<div class="body-container" style="background-color:#FEFCFF">
					<ul>				
						<li><a class="active" href="index.php">Iconic</a></li>
						<li><a href="index1.php">Franchise</a></li>
						<li><a href="index2.php">Customer</a></li>					
				  </ul>
					<form action ="index.php" method= "POST" class="login-form">
							<br>
							<h1 align="center">ICONIC LOGIN</h1>	
							<br><br>
