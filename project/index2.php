...
$sel_user = "SELECT * FROM `cruser` WHERE username='$myusername' AND password='$mypassword' AND type='customer'";
		...
		<div class="container">
				...
				<div class="body-container" style="background-color:#FEFCFF">
					<ul>				
						...
						<li><a class="active" href="index2.php">Customer</a></li>					
				  </ul>
					<form action ="index2.php" method= "POST" class="login-form">
							<br>
